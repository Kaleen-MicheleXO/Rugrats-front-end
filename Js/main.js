...
const url = `https://rugrats-api.herokuapp.com/api/${"tommypickles"}`;
...
function chuckieF(){
  document.querySelector('.card').classList.remove('hidden')
  const url = `https://rugrats-api.herokuapp.com/api/${"chuckiefinster"}`;
...
function lilD (){
  document.querySelector('.card').classList.remove('hidden')
  const url = `https://rugrats-api.herokuapp.com/api/${"lildeville"}`;
 ...
 function philD (){
  document.querySelector('.card').classList.remove('hidden')
    const url = `https://rugrats-api.herokuapp.com/api/${"phildevill"}`;
...
function angelicaP(){
  document.querySelector('.card').classList.remove('hidden')
  const url = `https://rugrats-api.herokuapp.com/api/${"angelicapickles"}`;
...
function susieC(){
  document.querySelector('.card').classList.remove('hidden')
  const url = `https://rugrats-api.herokuapp.com/api/${"susiecarmichael"}`;
...
function dilP(){
  document.querySelector('.card').classList.remove('hidden')
  const url = `https://rugrats-api.herokuapp.com/api/${"dilpickles"}`;
...
function kimiF(){
  document.querySelector('.card').classList.remove('hidden')
  const url = `https://rugrats-api.herokuapp.com/api/${"kimifinster"}`;
...
function onToTheNext() {
  ...
  const url = `https://rugrats-api.herokuapp.com/api/${charactername}`;
